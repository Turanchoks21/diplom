...
function NavBar() {
  ...
  return (
    <>
      <div
        className="fixed z-10 w-full mx-auto px-2 lg:px-48 xl:px-56 4xl:px-[26rem] 5xl:px-[34rem] 
        6xl:px-[46rem] 7xl:px-[58rem] 8xl:px-[68rem]
      bg-lavender-mist dark:bg-midnight-black border-b-2
      border-blue-purple transition-color ease-in-out duration-500
      text-white
      "
      >
        <div className="relative flex items-center justify-between h-16 3xl:h-28">
